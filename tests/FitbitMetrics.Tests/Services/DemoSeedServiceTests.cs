...
namespace FitbitMetrics.Tests.Services;

public sealed class DemoSeedServiceTests : IAsyncLifetime
{
    private SqliteConnection _connection = null!;
    private FitbitDbContext  _dbContext  = null!;
    ...
    public async Task InitializeAsync()
    {
        ...
        _dbContext = new FitbitDbContext(options);
    ...
    public async Task SeedAsync_SameDateAlwaysProducesSameHrValue()
    {
        ...
        var opts2 = new DbContextOptionsBuilder<FitbitDbContext>().UseSqlite(connection2).Options;
        await using var db2 = new FitbitDbContext(opts2);
